...
class WidgetFacet(QWidget):
    ...
    def __init__(self, parent: QWidget | None, app: "pyFadeApp", dataset: "DatasetDatabase", facet: "Facet | None"):
    ...
    def setup_ui(self):
        ...
        self.save_button.setStyleSheet("QPushButton { background-color: #1976D2; color: white; padding: 8px 16px; }")
    ...
    def save_facet(self):
        ...
        try:
            ...
            QMessageBox.information(
                self, 
                "Success", 
                f"Facet '{self.facet.name}' saved successfully!"
            )
