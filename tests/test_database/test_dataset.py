...
def test_dataset_transaction_management(temp_dataset: DatasetDatabase):
    ...
    Facet.create(temp_dataset, "TestFacet", "Test facet for transaction testing")
    temp_dataset.commit()
...
def test_dataset_session_management(temp_dataset: DatasetDatabase):
    ...
    Facet.create(temp_dataset, "SessionTest", "Testing session management")
    temp_dataset.commit()
...
def test_dataset_dispose_cleanup(temp_dataset: DatasetDatabase):
    ...
    Facet.create(temp_dataset, "DisposeTest", "Test disposal")
    temp_dataset.commit()
